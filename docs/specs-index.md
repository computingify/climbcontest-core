...
| [014](../specs/014-jeton-juge-dans-le-lien/) | `jeton-juge-dans-le-lien` | 🟠 **rédigée, pas codée** (30/08) | Le jeton du juge survit à l'installation de la PWA : il passe dans la requête et le manifeste devient dynamique, pour que `start_url` le porte |
