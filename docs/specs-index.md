...
| [023](../specs/023-fiche-du-grimpeur/) | `fiche-du-grimpeur` | 🟡 **codée, en attente de relecture** (01/09) | La bande à découper devient la **fiche de l'onglet `Fiches`** du classeur : identité, QR, **tous les blocs de son circuit** dans l'ordre de difficulté, et le **plan de la salle** avec ses zones allumées. Deux fiches par A4 |
| [024](../specs/024-etiquettes-de-blocs/) | `etiquettes-de-blocs` | 🟡 **codée, en attente de relecture** (01/09) | Les **étiquettes de blocs à coller au mur** — zone, numéro en gros, QR `ZJ6` généré localement, couleur des prises et **les circuits pour qui le bloc compte**. Six par A4, une zone par page |
