...
| [007](../specs/007-pwa-juge/) | `pwa-juge` | 🚧 **IT1 et IT2 livrées** (29/08) — 2 itérations restantes | L'application juge sur iPhone, sans payer de store. Une PWA servie par le backend, jeton dans le lien, jsQR versé dans le dépôt. File hors ligne en IndexedDB : le juge n'attend plus le réseau |
