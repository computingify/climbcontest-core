...
| [030](../specs/030-versions-visibles/) | `versions-visibles` | 🟡 **spec écrite, soumise à la porte 2** (02/09) | Tout est déjà versionné, rien n'est lisible : le tag git et le numéro de catalogue s'affichent enfin — dans les **réglages du téléphone**, avec un bouton qui **force la réception du catalogue** et un autre qui met à jour la coquille, et dans la **console**, où chaque téléphone dit quelle version et quel catalogue il porte. Un téléphone en retard cessait d'être discernable d'un téléphone à jour |
